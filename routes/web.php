...
use App\Http\Controllers\AcceptedRequest;
...
Route::post('/plugins/{plugin}/download/{request_id}', [PluginController::class, 'download'])->name('plugin.download');
...
// routes/web.php
Route::get('/accepted-requests', [AcceptedRequest::class, 'index'])->name('accepted-requests.index');


Route::post('/plugins/{plugin}/request-download/{request_id}', [PluginController::class, 'requestDownload'])->name('plugin.requestDownload');

Route::get('/thankYou', [PluginController::class, 'thankYou'])->name('thankYou');
